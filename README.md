...
- 🐍 Python is my primary language -> currently working as a Python back-end developer (async, high-load and stuff).
- 🎓 Master degree in theoretical physics, yet no need to ask me about the foundations of this Universe.
- 🔭 Interested in computer science (still), cognitive sciences, travelling and living without giving a damn.
- 👅 Languages:
  - 🇬🇧 English (B2-C1)
  - 🇫🇷 French (B1)
- 😄 Pronouns: he/him.
...
![ClickHouse](https://img.shields.io/badge/ClickHouse-FFCC01?style=for-the-badge&logo=clickhouse&logoColor=white) ![Redis](https://img.shields.io/badge/Redis-%23DD0031.svg?logo=redis&logoColor=white)
